...
# 頁面設定
st.set_page_config(page_title=" Basic Data Analysis Tool, was written by WILLIAM WU", layout="wide")
st.title("🔍 Basic Data Analysis Tool, Was written by WILLIAM WU")
